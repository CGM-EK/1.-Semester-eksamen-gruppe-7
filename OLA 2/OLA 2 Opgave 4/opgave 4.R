...
ggplot(data = forbrugsdata1, aes(x=TID, y=modeltal, group = FORMAAAL, color = FORMAAAL))+
  geom_line()
...
pf2024 <- sum(p.forbrug$value[101:104])
#1107.9

forbrugsdata2024 <- forbrugsdata1 %>% filter(forbrugsdata1$TID == "2024-01-01")
forbrugsdata2024$andel <- forbrugsdata2024$value/(pf2024*1000)*100

andelvector <- forbrugsdata2024$andel
