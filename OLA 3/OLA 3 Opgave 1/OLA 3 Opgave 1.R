...
f.tillid[311,12] <- f.tillid[311-4,12]
...
kvartalseq1 <- seq(1,307, 3)
kvartalseq2 <- seq(2,308, 3)
kvartalseq3 <- seq(3,309, 3)
...
lm.opt <- lm(f.tillidsammen$pfv ~ totalcordf$'Spg3 + Spg8 + Spg9 + Spg11 + Spg12')
summary(lm.opt)

#definerer koefficienter for den lm
std <- 0.27916
estimate <- -0.77709
k2 <- totalcordf$'Spg3 + Spg8 + Spg9 + Spg11 + Spg12'[102]
#forudsigelse for k3
pfvforudsigelsek3 <- estimate+std*k2

spgsss <- ((sum(f.tillid$Spg3[310:311])/2)+
             (sum(f.tillid$Spg8[310:311])/2)+
             (sum(f.tillid$Spg9[310:311])/2)+
             (sum(f.tillid$Spg11[310:311])/2)+
             sum(f.tillid$Spg12[310:311])/2)/5
